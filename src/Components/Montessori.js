  ...
  return (
    <div className="high-school">
      <div className="requirement-main">
        <h1>
          Cradle MONTESSORI is an <br /> exceptional educational <br />
          institution{" "}
        </h1>
      </div>
      {/* -------------------------------------- div1 */}
      <div  style={{backgroundColor:'red'}} className="requirement-body-author">
      ...
      {/* -------------------------------------------------div3 */}
      <div style={{backgroundColor:'skyblue'}} className="body-content1">
